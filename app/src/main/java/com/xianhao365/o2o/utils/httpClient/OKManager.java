...
//        headMsgJson.put("X-Nonce",getReqsn());
                ...
                .addHeader("X-User-ID", TextUtils.isEmpty(AppClient.USER_ID) ? "sdfSdfsdfsfsdf" : AppClient.USER_ID)
                .addHeader("X-User-Session",TextUtils.isEmpty(AppClient.USER_SESSION) ? "sdfsdfsdfsd" : AppClient.USER_SESSION)
