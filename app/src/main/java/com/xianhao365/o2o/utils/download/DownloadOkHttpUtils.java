package com.xianhao365.o2o.utils.download;
...
public class DownloadOkHttpUtils {
    public static void DownFile(final Context context){
        OkHttpUtils.get("http://download.dinpay.com/merchant/DinpayMerchantClient.apk")
                .tag("downapk")
                .execute(new FileCallback(SXUtils.getInstance(context).getSDPath()+"/apk","sx.apk") {
                    @Override
                    ...
                    public void downloadProgress(long currentSize, long totalSize, float progress, long networkSpeed) {
                        ...
                        if(currentSize == totalSize){
                            ...
                            intent.setDataAndType(Uri.fromFile(new File(SXUtils.getInstance(context).getSDPath()+"/apk/sx.apk")),
